...
window.XBOARD_TRANSLATIONS['ru-RU'] = {
  ...
  "settings": {
    ...
    "description": "Управление настройками сайта, безопасности, узлов, почты и уведомлений внутренней сети.",
    "server": {
    ...
    "site": {
      ...
      "description": "Базовая информация внутреннего сайта: название, описание и адрес доступа.",
      "form": {
        "siteName": {
